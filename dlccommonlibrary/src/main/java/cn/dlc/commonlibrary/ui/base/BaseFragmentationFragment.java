 ...
 */
public class BaseFragmentationFragment extends RxFragment implements ISupportFragment {

    final SupportFragmentDelegate mDelegate = new SupportFragmentDelegate(this);
    
    protected BaseFragmentationActivity _mActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        _mActivity = (BaseFragmentationActivity) mDelegate.getActivity();
    }
