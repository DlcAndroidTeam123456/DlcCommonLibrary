...
public class AlphaTabView extends View {
    ...
    public AlphaTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float defaultPadding = getResources().getDimension(R.dimen.alpha_tab_text_padding);
        mPadding = (int) a.getDimension(R.styleable.AlphaTabView_textPadding, defaultPadding);
